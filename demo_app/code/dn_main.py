...
def performDetect(imagePath="data/dog.jpg", thresh=0.25, configPath="./cfg/yolov4.cfg", weightPath="yolov4.weights",
    ...
    if showImage:
        try:
            ...
            out_name= basename = os.path.basename(imagePath)#addition in native code for saveing image
            ...
            # small adddition in native code to save the images in patj
            io.imsave(f'./results/{out_name}',image)# end of custom code
